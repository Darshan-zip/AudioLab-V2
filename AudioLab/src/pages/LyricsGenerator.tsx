...
const LyricsGeneratorPage = () => {
  useEffect(() => {
    ...
    iframe.src = "/lyrics-generator.html"; // Path to your custom HTML file
    iframe.style.width = "100%";
    iframe.style.height = "calc(100vh - 70px)"; // Adjust height as needed
    iframe.style.border = "none";
    
    const container = document.getElementById("lyrics-generator-container");
    if (container) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <div className="flex-1 flex flex-col">
        ...
        <div id="lyrics-generator-container" className="flex-1"></div>
      </div>
    </div>
  );
};
